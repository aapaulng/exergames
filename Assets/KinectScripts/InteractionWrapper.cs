...
public class InteractionWrapper
{
	...
	{
		public const int ColorImageWidth = 0;
		public const int ColorImageHeight = 0;
		public const NuiImageResolution ColorImageResolution = NuiImageResolution.resolutionInvalid;
		...
		public const float ClickMaxDistance = 0.07f;
...
//    }
	...
	public static int InitKinectSensor(int iColorResolution, int iDepthResolution, bool bNearMode)
	{
		int hr = InitKinectSensor(NuiInitializeFlags.UsesDepthAndPlayerIndex|NuiInitializeFlags.UsesSkeleton, true, iColorResolution, iDepthResolution, bNearMode);
		return hr;
	}
#endif
